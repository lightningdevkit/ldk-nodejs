...
const WeirdStruct = Struct({
	abc: ref.types.uint64,
	de: ref.types.uint8,
	gh: ref.types.uint8,
	ij: ref.types.uint8,
	kl: ref.types.uint8,
...
var LDKPeerManager = exports.LDKPeerManager = Struct({
	...
	_underlying_ref: ref.types.bool,
	arik_number: ref.types.uint8,
});
...
var LDKCResultPtr_CVecTempl_u8_____PeerHandleError = exports.LDKCResultPtr_CVecTempl_u8_____PeerHandleError = Union({
...
var ArikSubType = exports.ArikSubType = Struct({
...
const FooType = exports.FooType = Struct({
	...
	fourth: ref.types.uint8,
	fifth: ref.types.uint8,
	sixth: ref.types.uint8,
	seventh: ref.types.uint8,
	eigth: ref.types.uint8,
	ninth: ref.types.uint8,
	tenth: ref.types.uint8,
	eleventh: ref.types.uint8,
	twelvth: ref.types.uint8,
	thirteenth: ref.types.uint8,
	fourteenth: ref.types.uint8,
});

var ArikType = exports.ArikType = Struct({
	...
	// sixth: ref.types.uint8,
	// fourth: ref.refType(ref.types.uint8),
	// fifth: voidPtr,
	// sub: ArikSubType
});

// ArikType = LDKCResultTempl_CVecTempl_u8_____PeerHandleError;


exports.liblightning = new FFI.Library(__dirname + '/../../lib/liblightning_c_bindings', {
